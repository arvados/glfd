...
static int default_score_func(char x, char y) {
...
int asm_ukk_align_dna(char **X, char **Y, char *a, char *b, char gap_char) {
  return asm_ukk_align3(X, Y, a, b, default_score_func, gap_char);
}
